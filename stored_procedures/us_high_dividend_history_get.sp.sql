...
INSERT #RESULT
      (bdate, security_id, eq_div_flg, div_yield, dps_growth, div_payout_ltm, debt_to_capital,
       interest_coverage, fcf_ltm_to_div_ltm, div_yield_to_5yr_avg,
       pb_to_5yr_avg, sp_current_rating, sp_senior_rating)
SELECT bdate, security_id, 0, div_yield, dps_growth, div_payout_ltm, debt_to_capital,
       interest_coverage, fcf_ltm_to_div_ltm, div_yield_to_5yr_avg,
       pb_to_5yr_avg, sp_current_rating, sp_senior_rating
